    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-4 text-sm mt-1">CompTIA Study · {window.location.hostname}</p>
        </div>
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-ink-3 mb-1.5">Email</label>
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-ink-3 mb-1.5">Password</label>
        ...
        <p className="text-center text-sm text-ink-5 mt-4">
          No account? <Link to="/register" className="text-blue-700 dark:text-blue-400 hover:underline">Create one</Link>
        </p>
        <p className="text-center text-sm text-ink-5 mt-2">
          <Link to="/" className="text-ink-4 hover:text-ink">Continue without signing in →</Link>
        </p>
      </div>
    </div>
  )
